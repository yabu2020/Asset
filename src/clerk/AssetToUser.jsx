...
function AssetToUser() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-gray-100 rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold text-gray-800 mb-6">Assign Asset to User</h2>
      ...
      <div className="mb-6">
        <label htmlFor="user-select" className="block text-lg font-medium text-gray-700 mb-2">Select User:</label>
        <select
          id="user-select"
          value={selectedUser}
